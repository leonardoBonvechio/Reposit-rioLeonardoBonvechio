...
public class Tela extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        float numA = Float.valueOf(txtNumeroA.getText());
        float numB = Float.valueOf(txtNumeroB.getText());
        float numC = Float.valueOf(txtNumeroC.getText());
        float result = (numA + numB) / numC;
