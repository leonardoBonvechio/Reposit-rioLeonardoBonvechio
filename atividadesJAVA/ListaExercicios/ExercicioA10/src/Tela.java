...
public class Tela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Total Eleitores: ");

        jLabel3.setText("Total Votos: ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int totalEleitores = Integer.valueOf(txtTotal.getText());
        int totalVotos     = Integer.valueOf(txtVotos.getText());
        
        float percEleitores = (totalVotos*100) / totalEleitores;
                
        txtResultado.setText(
                "Na cidade de " + nomeCidade + ", votaram " +
                percEleitores + "% dos eleitores ativos."       );
