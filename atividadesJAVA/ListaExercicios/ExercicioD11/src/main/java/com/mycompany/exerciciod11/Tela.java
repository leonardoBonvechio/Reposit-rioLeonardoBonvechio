 ...
 */
package com.mycompany.exerciciod11;
...
public class Tela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Número atual de habitantes:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int habitantes = Integer.valueOf(txtHabitantes.getText());
        
        for(int ano = 1; ano <= 5; ano++){
            habitantes = (int) (habitantes + (habitantes * 0.003));
            JOptionPane.showMessageDialog(rootPane, 
                    "No ano " + ano + ", o país possui: " + 
