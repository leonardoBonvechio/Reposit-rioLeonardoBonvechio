 ...
 */
package com.mycompany.exerciciod4;
...
public class Tela extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int anoBase = Integer.valueOf(txtAno.getText());
        
               String resultado = "Anos bissextos: ";
        
        for(int contador = anoBase+1; contador <= anoBase+20; contador++){
            // ano bissexto é aquele que o %4 é 0!!!
            if((contador % 4) == 0){
